...
**No reportar Dev C como “hecho”** mientras falte smoke prod de 501, merge+QA de 304, y QA documentado de 303. Backfill QA 001–302 **completado** (2026-07-16). QA adversarial de 501 ya está hecho (fixes mergeados). Ver checklist en [`team/STATUS.md`](./team/STATUS.md).
...
- [ ] PAAG-101 [A] Modelos y migraciones del banco (`Subject/Topic/Exercise/ExerciseStep/Hint`) + seeds — [ticket](./tickets/PAAG-101-modelos-banco.md)
