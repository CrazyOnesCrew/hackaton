...
const envSchema = z.object({
  ...
  EXPO_PUBLIC_USE_MOCK_API: z.boolean().optional(),
...
const BUNDLE_IDS = {
  development: 'com.example.template.development',
  preview: 'com.example.template.preview',
...
const SCHEMES = {
  development: 'templateapp',
  preview: 'templateapp.preview',
  production: 'templateapp',
} as const;
...
const _env: z.infer<typeof envSchema> = {
  ...
  EXPO_PUBLIC_API_URL:
    ...
    ?? (EXPO_PUBLIC_APP_ENV === 'development' ? 'http://127.0.0.1:3000' : ''),
