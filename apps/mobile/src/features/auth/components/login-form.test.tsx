...
describe('loginForm Form ', () => {
  ...
  it('should display required error when values are empty', async () => {
    ...
    expect(screen.queryByText(/El correo es obligatorio/i)).not.toBeOnTheScreen();
    await user.press(button);
    expect(await screen.findByText(/El correo es obligatorio/i)).toBeOnTheScreen();
    expect(screen.getByText(/La contraseña es obligatoria/i)).toBeOnTheScreen();
  });
  ...
  it('should display matching error when email is invalid', async () => {
    ...
    expect(await screen.findByText(/Formato de correo inválido/i)).toBeOnTheScreen();
    expect(screen.queryByText(/El correo es obligatorio/i)).not.toBeOnTheScreen();
  });
  ...
  it('shows an apiError message when provided', async () => {
    setup(<LoginForm apiError="Correo o contraseña incorrectos." />);
